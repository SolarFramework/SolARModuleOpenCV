...
int main(int argc,char** argv)
{
    ...
    if(xpcfComponentManager->load("SolARTest_ModuleOpenCV_DescriptorMatcher_conf.xml")!=org::bcom::xpcf::_SUCCESS)
    {
        LOG_ERROR("Failed to load the configuration file SolARTest_ModuleOpenCV_DescriptorMatcher_conf.xml")
        return -1;
    }
