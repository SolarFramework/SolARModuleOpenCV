...
TARGET = SolARTest_ModuleOpenCV_StereoImageRectification
VERSION=1.0.0
...
configfile.files = $$files($${PWD}/SolARTest_ModuleOpenCV_StereoImageRectification_conf.xml)
INSTALLS += configfile
...
DISTFILES += \
    SolARTest_ModuleOpenCV_StereoImageRectification_conf.xml \
