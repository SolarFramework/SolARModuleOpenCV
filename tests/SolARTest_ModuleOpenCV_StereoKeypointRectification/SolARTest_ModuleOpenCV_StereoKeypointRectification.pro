...
TARGET = SolARTest_ModuleOpenCV_StereoKeypointRectification
VERSION=1.0.0
...
configfile.files = $$files($${PWD}/SolARTest_ModuleOpenCV_StereoKeypointRectification_conf.xml)
INSTALLS += configfile
...
DISTFILES += \
    ...
    SolARTest_ModuleOpenCV_StereoKeypointRectification_conf.xml
