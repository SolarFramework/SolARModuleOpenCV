...
int main() {
    ...
    try{
        ...
        if(xpcfComponentManager->load("SolARTest_ModuleOpenCV_FundamentalMatrixDecomposer_conf.xml")!=org::bcom::xpcf::_SUCCESS)
        {
            LOG_ERROR("Failed to load the configuration file SolARTest_ModuleOpenCV_FundamentalMatrixDecomposer_conf.xml")
            return -1;
        }
