...
int main(int argc,char* argv[])
{
    ...
    try {
        ...
        if(xpcfComponentManager->load("SolARTest_ModuleOpenCV_DeepLabV3PlusSegmentation_conf.xml")!=org::bcom::xpcf::_SUCCESS)
        {
            LOG_ERROR("Failed to load the configuration file SolARTest_ModuleOpenCV_DeepLabV3PlusSegmentation_conf.xml")
            return -1;
        }
