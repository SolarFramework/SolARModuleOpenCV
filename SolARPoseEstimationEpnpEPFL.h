...
#ifndef SOLARPOSEESTIMATIONEPNPEPFL_H
#define SOLARPOSEESTIMATIONEPNPEPFL_H
...
class SOLAROPENCV_EXPORT_API SolARPoseEstimationEpnpEPFL : public org::bcom::xpcf::ComponentBase,
    public api::solver::pose::I3DTransformFinder
{
public:
    SolARPoseEstimationEpnpEPFL();
    ...
    FrameworkReturnCode estimate( Pose & pose, const std::vector<SRef<Point2Df>> & imagePoints, const std::vector<SRef<Point3Df>> & worldPoints) override;
