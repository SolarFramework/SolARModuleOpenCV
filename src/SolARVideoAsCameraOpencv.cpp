...
namespace OPENCV {
    ...
    FrameworkReturnCode SolARVideoAsCameraOpencv::setResolution(Sizei resolution)
    {
    ...
    FrameworkReturnCode SolARVideoAsCameraOpencv::setIntrinsicParameters(const CamCalibration & intrinsic_parameters){
        return FrameworkReturnCode::_NOT_IMPLEMENTED;
    }

     FrameworkReturnCode SolARVideoAsCameraOpencv::setDistortionParameters(const CamDistortion & distortion_parameters){
        return FrameworkReturnCode::_NOT_IMPLEMENTED;
     }
    ...
    const CamCalibration& SolARVideoAsCameraOpencv::getIntrinsicsParameters() const{
        return m_intrinsic_parameters;
    }

    const CamDistortion& SolARVideoAsCameraOpencv::getDistortionParameters() const{
