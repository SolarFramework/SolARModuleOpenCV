...
bool SolARSVDFundamentalMatrixDecomposerOpencv::decompose(const Transform2Df & F, const SolAR::datastructure::CameraParameters & camParams, std::vector<Transform3Df> & decomposedPoses)
{
