...
public:
	...
	void draw(const SRef<datastructure::Image> image1, const SRef<datastructure::Image> image2, SRef<datastructure::Image> & outImage, const std::vector <datastructure::Keyline> & keylines_image1, const std::vector <datastructure::Keyline> & keylines_image2, const std::vector<datastructure::DescriptorMatch> & matches = std::vector<datastructure::DescriptorMatch>()) override;
