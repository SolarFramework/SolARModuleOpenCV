...
public:
    ...
    void drawMatchesLines(const SRef<Image> image1, const SRef<Image> image2, SRef<Image> & outImage, const std::vector <SRef<Point2Df>> & points_image1, const std::vector <SRef<Point2Df>> & points_image2, const std::vector<DescriptorMatch> matches = std::vector<DescriptorMatch>()) override;
    ...
    /// @param[in|out] matches, a vector of matches between the first and second image that will be displayed. If this vector is empty, we consider that the ith point of points_image1 matches with the ith point of points_image2.
    void drawMatchesLines(const SRef<Image> image1, const SRef<Image> image2, SRef<Image> & outImage, const std::vector <SRef<Keypoint>> & keypoints_image1, const std::vector <SRef<Keypoint>> & keypoints_image2, const std::vector<DescriptorMatch> matches = std::vector<DescriptorMatch>()) override;
